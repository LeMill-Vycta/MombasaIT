    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card h-auto">
                ...
                <div class="card-body">
                   <p class="h5"> Client Name: &nbsp; {{ucfirst($progress->user->name ?? null ?: 'N/A')}}</p></br>
                   <p class="h5"> Phone: &nbsp; {{$progress->user->phone_number ?? null ?: 'N/A'}}</p></br>
                   <p class="h5"> Email: &nbsp; {{$progress->user->email ?? null ?: 'N/A'}}</p></br>
                   <p class="h5"> Service: &nbsp; {{$progress->service ?? null ?: 'N/A'}}</p></br>
                   <p class="h5"> Date Started: &nbsp; {{$progress->date_started}}</p></br>
                   <p class="h5"> Date Completed: &nbsp; {{$progress->date_completed}}</p></br>
                </div>
        ...
        <div class="col-md-8">
            ...
            <form action="{{route('progress.update',[$progress->id])}}" method="post" enctype="multipart/form-data">@csrf
            <div class="card">
                <div class="card-header">
                <h4 class="text-center card-title">Update Report</h4>
                <a href="{{ url()->previous() }}"><span class="font3">BACK</span>
