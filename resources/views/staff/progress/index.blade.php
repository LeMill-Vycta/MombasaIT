                    ...
                    <table class="table header-border table-hover verticle-middle text-center">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="font4">
                          <div class="d-flex">
                                <a href="{{route('progress.edit',[$progress->id])}}" class="btn btn-success shadow btn-sm sharp mr-1"><i class="fa fa-pencil"></i></a>
                            </div>
                          </td>
                          <td>
                            @if($progress->cancel==0)
                            <a href="{{route('update.cancel',[$progress->id])}}"><button class="btn btn-xs btn-info font2"> NO</button></a>
                            @else
                            <a href="{{route('update.cancel',[$progress->id])}}"><button class="btn btn-xs btn-danger font2"> YES</button></a>
                            @endif
                          </td>
                        </tr>
                        @empty
