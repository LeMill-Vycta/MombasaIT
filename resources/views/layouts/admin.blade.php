				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="{{ asset('/index.html') }}">Dashboard</a></li>
							<li><a href="{{ asset('/doctors.html') }}">Doctors</a></li>
							<li><a href="{{ asset('/doctors-details.html') }}">Doctors Details</a></li>
							<li><a href="{{ asset('/doctors-review.html') }}">Doctors Review</a></li>
							<li><a href="{{ asset('/patient-details.html') }}">Patient Details</a></li>
						</ul>
