                    ...
                    <table class="table header-border table-hover verticle-middle ">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="font4"><img src="{{ asset('\images')}}\{{$invoice->staff->image ?? null ?: 'N/A'}}" alt="" width="60px" height="60px" style="border-radius:15%;"></td>
                          <td class="font4">{{ucfirst($invoice->staff->name ?? null ?: 'N/A')}}</td>
                          ...
                          <div class="text-center">
                                <a href="{{route('admin-invoices.show',[$invoice->id])}}" class="btn btn-success shadow btn-sm sharp mr-1">
                          ...
                          <td>
                          <div class="text-center">
                                <a href="{{route('adminprogress.edit',[$invoice->id])}}" class="btn btn-primary shadow btn-sm sharp mr-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" fill="white" width="15" height="15"><path d="M23.821,11.181v0C22.943,9.261,19.5,3,12,3S1.057,9.261.179,11.181a1.969,1.969,0,0,0,0,1.64C1.057,14.739,4.5,21,12,21s10.943-6.261,11.821-8.181A1.968,1.968,0,0,0,23.821,11.181ZM12,18a6,6,0,1,1,6-6A6.006,6.006,0,0,1,12,18Z"/><circle cx="12" cy="12" r="4"/></svg>
                                </a>
                            </div>
                          </td>
                          <td>
                            @if($invoice->paid==0)
                            <a href="{{route('update.paid',[$invoice->id])}}"><button class="btn btn-xs btn-danger font2"> NO</button></a>
                            @else
                            <a href="{{route('update.paid',[$invoice->id])}}"><button class="btn btn-xs btn-info font2"> YES</button></a>
                            @endif
                          </td>
                        </tr>
                        @empty
