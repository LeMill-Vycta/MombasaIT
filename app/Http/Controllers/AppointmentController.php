...
class AppointmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.appointment.index',compact('myappointments'));
    }
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            'date'=>'required|after:yesterday|unique:appointments,date,NULL,id,user_id,'.\Auth::id() ,
            'time'=>'required'
        ]);
    ...
    public function check(Request $request){
        ...
        return view('staff.appointment.index',compact('times','appointmentId','date','services'));
    }

    public function findSlotBasedOnDate($date)
    {
    ...
    public function updateTime(Request $request){
        ...
        $service = Appointment::where('id',$appointmentId)->update(array('services_id'=>$services));
        foreach($request->time as $time){
            Time::create([
